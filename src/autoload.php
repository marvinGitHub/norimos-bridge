...
require_once 'AlarmHistory.php';
require_once 'QueueMQTT.php';
...
require_once 'PluginPrinterLogProcessor.php';
require_once 'PluginMQTTPublisherAbstract.php';
require_once 'AlarmPublisher.php';
